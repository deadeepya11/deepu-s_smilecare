...
function createSupabaseClient() {
  ...
  if (!SUPABASE_URL || !SUPABASE_PUBLISHABLE_KEY) {
    ...
    const message = `Missing Supabase environment variable(s): ${missing.join(', ')}. Configure SUPABASE_URL / SUPABASE_PUBLISHABLE_KEY in your server environment, plus VITE_SUPABASE_URL / VITE_SUPABASE_PUBLISHABLE_KEY for the client build.`;
